...
def main():
    ...
    print("\n[1/6] Generating sensitivity comparison plot...")
    plot_sensitivity()

    print("\n[2/6] Generating detector comparison plot...")
    plot_detector()

    print("\n[3/6] Generating false fetal frequency comparison plot...")
    plot_false_f()

    print("\n[4/6] Generating sample time-of-flight plot...")
    plot_sample_tof(plot_type="distribution")
    plot_sample_tof(plot_type="density")

    print("\n[5/6] Generating overlap comparison plot...")
    plot_overlap_compare()

    print("\n[6/6] Generating overlap comparison plot (variant)...")
