...
def main():
    ...
    fig.savefig(figure_output_path(figures_dir / "detector_comparison.pdf", inject_noise), format="pdf")
    fig.savefig(figure_output_path(figures_dir / "detector_comparison.svg", inject_noise), format="svg")
