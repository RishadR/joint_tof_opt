...
def main():
    ...
    fig.savefig(figure_output_path(figures_dir / "sensitivity_comparison2.pdf", inject_noise), format="pdf")
    fig.savefig(figure_output_path(figures_dir / "sensitivity_comparison2.svg", inject_noise), format="svg")
