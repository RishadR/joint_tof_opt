...
5. Compute th e Energy Ratio Metric between the maternal filtered and fetal filtered signal
...
for epoch in range(num_epochs):
    ...
    metric_value = energy_ratio_metric(fetal_filtered_signal, maternal_filtered_signal)
